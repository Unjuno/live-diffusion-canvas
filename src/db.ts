...
export type StoredSnapshot = { id:string; createdAt:number; generatedImage:string; prompt:string; note:string; importedImage?:string; humanDrawLayer?:[number,number][]; guideEraseMask?:string; guideComposite?:string; lastNoiseMask?:[number,number][] };
